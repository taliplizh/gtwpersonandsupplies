...
<div class="block" style="width: 95%;margin:10px auto 20px">
    <div class="block block-rounded block-bordered">
        <div class="block-content">
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">เพิ่มประเภทคลังสำหรับยาและเวชภัณฑ์</h2>
            <div class="block-content block-content-full" align="left">
                <form method="post" action="{{ route('mmedical.setting_inventory_save') }}"
