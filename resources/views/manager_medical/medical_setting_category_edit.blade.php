...
<div class="block" style="width: 95%;margin:10px auto 20px">
    <div class="block block-rounded block-bordered">
        <div class="block-content">
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขประเภทหมวดสำหรับยาและเวชภัณฑ์</h2>
            <div class="block-content block-content-full" align="left">
                <form method="post" action="{{ route('mmedical.setting_category_update') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="SETCATEGORY_ID" value="{{$setcate->SETCATEGORY_ID}}">
                    <div class="row push">
                        <div class="col-sm-2">
                        ...
                        <div class="col-lg-4">
                            ...
                            @endphp
                            @if($setcate->SUP_TYPE_ID == $supcate->SUP_TYPE_ID)
                            <option value="{{$data}}" selected>{{$supcate->SUP_TYPE_NAME}}</option>
                            @else
