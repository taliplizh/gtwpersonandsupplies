...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลช่วงเวลา</h2>    

    
        <form  method="post" action="{{ route('admin.saveroomtime') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
      ...
      <div class="col-lg-4">
      <input  name = "TIME_SC_NAME"  id="TIME_SC_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_time_sc_name();">
      ...
      <div class="col-lg-2">
      <input  name = "TIME_SC_BEGIN"  id="TIME_SC_BEGIN" class="js-masked-time form-control" style=" font-family: 'Kanit', sans-serif;" onchange="check_time_sc_begin();">
      ...
      <div class="col-lg-2">
      <input  name = "TIME_SC_END"  id="TIME_SC_END" class="js-masked-time form-control" style=" font-family: 'Kanit', sans-serif;" onchange="check_time_sc_end();">
      <div style="color: red; font-size: 16px;" id="time_sc_end"></div> 
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save"></i>  บันทึกข้อมูล</button>
         <a href="{{ url('admin_meeting/setupinforoomtime')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i>   ยกเลิก</a> 
         </div>    
