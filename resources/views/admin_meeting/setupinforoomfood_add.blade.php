...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลเมนู</h2>    

    
        <form  method="post" action="{{ route('admin.saveroomfood') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
      ...
      <div class="col-lg-3">
      <input  name = "FOOD_NAME"  id="FOOD_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_food_name();">
      ...
      <div class="col-lg-3">
      <input  name = "FOOD_PRICE"  id="FOOD_PRICE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_food_price();">
      ...
      <div class="col-lg-3">
      <input  name = "FOOD_UNIT"  id="FOOD_UNIT"  class="form-control input-lg "  style=" font-family: 'Kanit', sans-serif;" onkeyup="check_food_unit();">
      ...
      <select name="FOOD_TYPE_ID" id="FOOD_TYPE_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;font-size: 13px;" onchange="check_food_type_id();">
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save"></i>  บันทึกข้อมูล</button>
         <a href="{{ url('admin_meeting/setupinforoomfood')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" > <i class="fas fa-window-close"></i>ยกเลิก</a> 
         </div>    
