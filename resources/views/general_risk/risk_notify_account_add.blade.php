                ...
                <div class="block-content block-content-full" >
                    ...
                    <form method="post" action="{{ route('gen_risk.risk_notify_account_save') }}" enctype="multipart/form-data">
                        ...
                        <div class="row push">
                            ...
                            <div class="col-lg-2 ">
                                {{-- <input type="text" name="RISK_ACCOUNT_RISK_LEVEL" id="RISK_ACCOUNT_RISK_LEVEL" class="form-control input-sm risklevel foo13"> --}}
                                <select name="RISK_ACCOUNT_RISK_LEVEL" id="RISK_ACCOUNT_RISK_LEVEL" class="form-control input-sm risklevel fo13">
                                    <option value="">--กรุณาเลือก--</option>
                                        {{-- @foreach ($risklevels as $risklevel)                                   
                                            <option value="{{ $risklevel->RISK_ACCOUNTRISKLEVEL_CODE }}">{{ $risklevel->RISK_ACCOUNTRISKLEVEL_CODE }}  ::  {{ $risklevel->RISK_ACCOUNTRISKLEVEL_NAME }}
                                        @endforeach --}}
                                </select>
                            </div>
                        </div>
