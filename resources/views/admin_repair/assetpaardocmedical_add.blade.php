...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content"> 
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มชื่อรายการ</h2>    
        <form  method="post" action="{{ route('admin.saveassetpaardocmedical') }}" enctype="multipart/form-data">
            @csrf
            <div class="row push">
                <div class="col-lg-2">
                ...
                <div class="col-lg-10">
                    <input  name = "AR_TOOLS_NAME"  id="AR_TOOLS_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_artoolsname();">
                ...
                <div class="col-lg-3">    
                    <input  name = "RANGE_VALUE"  id="RANGE_VALUE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_rangevalue();">
                ...
                <div class="col-lg-2">
                    <input  name = "RANGE_ACCEPT"  id="RANGE_ACCEPT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_rangeaccept();">
                ...
                <div class="col-lg-2">
                    <input  name = "UNIT_NAME"  id="UNIT_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_unitname();">
            ...
            <div align="right">
                ...
                <a href="{{ url('admin_repair/Setupassetpaardocmedical')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i>  ยกเลิก</a> 
            </div>
        </div>
        </form>  
