...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content"> 
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลประเภทซ่อมเพื่อทำรายงาน</h2>    
        <form  method="post" action="{{ route('admin.saveinformcomrepairtype') }}" enctype="multipart/form-data">
            @csrf
            <div class="row push">
                <div class="col-lg-2">
                ...
                <div class="col-lg-3">
                    <input  name = "COM_REPAIR_TYPE_NAME"  id="COM_REPAIR_TYPE_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_comrepairtypename();">
                ...
                <div class="col-lg-5">
                    <input  name = "COM_REPAIR_TYPE_DETAIL"  id="COM_REPAIR_TYPE_DETAIL" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_comrepairtypedetail();">
            ...
            <div align="right">
                ...
                <a href="{{ url('admin_repair/Setupinformcomrepairtype')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i> &nbsp;ยกเลิก</a> 
            </div>
        </div>
        </form>  
