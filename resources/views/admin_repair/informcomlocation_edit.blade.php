...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content"> 
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขสถานที่ตั้ง</h2> 
    <form  method="post" action="{{ route('admin.updateinformcomlocation') }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row push">
                                    ...
                                    <div class="col-lg-3">
                                        <input  name = "LOCATION_NAME"  id="LOCATION_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoinformcomlocationT->LOCATION_NAME}}" onkeyup="check_locationname();">
                                    ...
                                    <div class="col-lg-4">
                                        {{-- <input  name = "BUILDING"  id="BUILDING" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;font-size: 13px;" value="{{$infoinformcomlocationT->BUILDING_NAME}}">
                                        <input type="hidden" name = "BUILDING_ID"  id="BUILDING_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoinformcomlocationT->BUILDING_ID}}"> --}}
                                        <select name="BUILDING_ID" id="BUILDING_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onchange="check_buildingid();">
                                            <option value="">--เลือกอาคาร--</option>
                                                 @foreach ($buildingT as $building) 
                                                    @if($infoinformcomlocationT -> BUILDING_ID == $building-> BUILDING_ID )                                                     
                                                        <option value="{{$building-> BUILDING_ID }}" selected>{{ $building-> BUILDING_NAME }}</option>                                            
                                                    @else
                                    ...
                                    <div class="col-lg-2">
                                            <input  name = "CLASS"  id="CLASS" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoinformcomlocationT->CLASS}}" onkeyup="check_classZ();">
                                            <div style="color: red; font-size: 16px;" id="classZ"></div> 
                                        </div>
                                               
                        <input type="hidden"  name = "LOCATION_ID"  id="LOCATION_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoinformcomlocationT->LOCATION_ID}}">
                    </div>
