...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content"> 
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลรายการซ่อม</h2>    
        <form  method="post" action="{{ route('admin.saveinformcomrepairlist') }}" enctype="multipart/form-data">
            @csrf
            <div class="row push">
                <div class="col-lg-2">
                ...
                <div class="col-lg-4">
                    <input  name = "REPAIR_LIST_NAME"  id="REPAIR_LIST_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_repairname();">
                ...
                <div class="col-lg-5">
                    <input  name = "REPAIR_LIST_PRICE"  id="REPAIR_LIST_PRICE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_repairlistprice();">
            ...
            <div align="right">
                ...
                <a href="{{ url('admin_repair/Setupinformcomrepairlist')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i> &nbsp;ยกเลิก</a> 
            </div>
        </div>
        </form>  
