    ...
    <div class="block-content">
      ...
      <div class="row push fs-16">
        ...
        <div id="c1" class="col-lg-12 mb-2 pt-5">
          <h1 class="fw-b">1. ใส่ลิงก์เพจ</h1>
          <img class="shadow mb-3" src="{{asset('image/plugin_page_facebook.png')}}"  width="100%" alt="" srcset="">
          <p>กรอกลิงก์ เพจที่ต้องการแสดงลงในช่อง <span style="text-decoration:underline;">URL เพจ Facebook</span> เช่น เพจโรงพยาบาลสำหรับประชาสัมพันธ์</p>
