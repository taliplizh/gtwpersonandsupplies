...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> แก้ไขข้อมูลบุคลากร</h2>    

    
        <form  method="post" action="{{ route('setup.infolevelgroup_update') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
           ...
           <select name="PERSON_ID" id="PERSON_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;font-size: 13px;" >
            <option value="">--เลือกบุคลากร--</option>
                @foreach($infopersons as $infoperson)
                    @if($infoperson->ID == $infopersonuse)
