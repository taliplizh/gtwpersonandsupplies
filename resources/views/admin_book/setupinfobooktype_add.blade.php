...
?>
        ...
        <form  method="post" action="{{ route('admin.savebooktype') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-2">
      ...
      <div class="col-lg-3">
      <input  name = "BOOK_TYPE_NAME"  id="BOOK_TYPE_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_book_type_name();">
      <div style="color: red; font-size: 16px;" id="book_type_name"></div>
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกข้อมูล</button>
         <a href="{{ url('admin_book/setupbooktype')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a> 
         </div>    
