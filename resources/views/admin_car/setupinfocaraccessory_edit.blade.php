...
?>
        ...
        <form  method="post" action="{{ route('admin.updatecaraccessory') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-2">
      ...
      <div class="col-lg-3">
      <input  name = "ACCESSORY_NAME"  id="ACCESSORY_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"  value="{{$infocaraccessory->ACCESSORY_NAME}}"  onkeyup="check_accessorry_name();">
      <div style="color: red; font-size: 16px;" id="accessorry_name"></div> 
    </div>
     
      <input  type="hidden" name = "ACCESSORY_ID"  id="ACCESSORY_ID" class="form-control input-lg" value="{{$infocaraccessory->ACCESSORY_ID}}">
