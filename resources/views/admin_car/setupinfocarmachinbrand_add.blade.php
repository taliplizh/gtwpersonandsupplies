...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลยี่ห้อเครื่องยนต์</h2>    

    
        <form  method="post" action="{{ route('admin.savecarmachinbrand') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-2">
      ...
      <div class="col-lg-3">
      <input  name = "CAR_MACHIN_BRAND_NAME"  id="CAR_MACHIN_BRAND_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_car_machin_brand_name();">
      <div style="color: red; font-size: 16px;" id="car_machin_brand_name"></div>   
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกข้อมูล</button>
         <a href="{{ url('admin_car/setupcarmachinbrand')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a> 
         </div>    
