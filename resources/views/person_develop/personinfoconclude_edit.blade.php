...
<body onload="run01();">
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขสรุปรายงานการอบรม<label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่รายงานการอบรม {{ DateThai(date("Y-m-d"))}}</label></h2> 
                        
        <form  method="post" action="{{ route('perdev.updateconclude') }}"  enctype="multipart/form-data">
        @csrf
        
        <input type="hidden" name="ID_BACK" id="ID_BACK"  value="{{$idback}}">
                            ...
                            <div class="block block-rounded block-bordered">
                                ...
                                <div class="block-content tab-content">
                                    ...
                                    <tr>
                                        ...
                                        <select name="PERSON_ID[]" id="PERSON_ID{{$checkper}}" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onchange="checkposition({{$checkper}});checklevel({{$checkper}})">
                                                        <option value="">--กรุณาเลือกผู้ร่วมเดินทาง--</option>
                                                            ...
                                                            @if($infoconcludeperson->PERSON_ID == $PERSONALL ->ID)                                                    
                                    ...
                                    <table class="table gwt-table" >
                                        ...
                                        @foreach ($infoconcludeobjs as $infoconcludeobj) 
                                    <tr>
                                        <td> 
                                        <input name="OBJECTIVE_NAME[]" id="OBJECTIVE_NAME[]" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoconcludeobj->OBJECTIVE_NAME}}">
                                    ...
                                    <div class="tab-pane" id="object3" role="tabpanel">
                                        ...
                                        <tbody class="tbody3"> 
                                        @foreach ($infoconcludeimps as $infoconcludeimp)   
                                    <tr>
                                        <td> 
                                        <input name="IMPORTANT_NAME[]" id="IMPORTANT_NAME[]" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoconcludeimp->IMPORTANT_NAME}}">
                                    ...
                                    <tr>
                                       <td> <select name="MONEY_TYPE_ID[]" id="MONEY_TYPE_ID[]" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
                                                            ...
                                                            @foreach ($moneysets as $moneyset)  
                                                                @if($infoconcludemoney->MONEY_TYPE_ID == $moneyset ->MONEY_ID)                                                   
                                        ...
                                        <td> <input name="MONEY[]" id="MONEY[]" class="form-control input-lg items" style=" font-family: 'Kanit', sans-serif;" onkeyup="callmoney()" value="{{$infoconcludemoney->MONEY}}"></td>
                                        <td> <input name="DETAILMONEY[]" id="DETAILMONEY[]" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoconcludemoney->DETAIL}}"></td>
                                    ...
                                    <div class="tab-pane" id="object7" role="tabpanel">
                                        ...
                                        <textarea name="DETAIL" id="DETAIL" rows="4" cols="50" class="form-control" style=" font-family: 'Kanit', sans-serif;background-color: #F0F8FF;" >{{$infobackget->DETAIL}}</textarea>
                                    ...
                                    <table class="table gwt-table" >
                                        ...
                                        <tbody class="tbody8">
                                        @foreach ($infoconcludeknows as $infoconcludeknow)    
                                    <tr>
                                        <td> 
                                        <input name="KNOWLEDGE_NAME[]" id="KNOWLEDGE_NAME[]" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoconcludeknow->KNOWLEDGE_NAME}}">
                                   ...
                                   <div class="tab-pane" id="object9" role="tabpanel">
                                    <table class="table gwt-table" >
                                        ...
                                        <tbody class="tbody9">   
                                    <tr>
                                    @foreach ($infoconcludebens as $infoconcludeben)    
                                        <td> 
                                        <input name="BENEFIT_NAME[]" id="BENEFIT_NAME[]" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoconcludeben->BENEFIT_NAME}}">                                        
                                        </td>
                                        <td> 
                                        <input name="BENEFIT_EX[]" id="BENEFIT_EX[]" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoconcludeben->BENEFIT_EX}}" >                                        
                                        </td>
       ...
       <input type="hidden" name ="PERSON_ID_CREATE" id="PERSON_ID_CREATE" class="form-control input-lg" value="{{$inforpersonuserid -> ID }}">
        ...
        <a href="{{ url('person_dev/persondevinfo/'.$inforpersonuserid -> ID)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขสรุป ?')" >ยกเลิก</a>
        </div>
