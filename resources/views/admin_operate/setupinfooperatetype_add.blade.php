...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลประเภทเวร</h2>    

    
        <form  method="post" action="{{ route('admin.saveoperatetype') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
      ...
      <div class="col-lg-3">
      <input  name = "OPERATE_TYPE_NAME"  id="OPERATE_TYPE_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_operate_type_name();">
      ...
      <div class="col-lg-3">
      <input  name = "OPERATE_TYPE_UNIT_OT"  id="OPERATE_TYPE_UNIT_OT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_operate_type_unit_ot();">
      <div style="color: red; font-size: 16px;" id="operate_type_unit_ot"></div>
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save mr-2"></i>  บันทึกข้อมูล</button>
         <a href="{{ url('admin_operate/setupoperatetype')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i>  ยกเลิก</a> 
         </div>    
