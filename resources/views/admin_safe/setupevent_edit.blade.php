...
<div class="content">
    ...
    <form  method="post" action="{{ route('admin.updateevent') }}" enctype="multipart/form-data">
        @csrf
                <div class="row push">
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-6">
                    <input  name = "SAFE_EVENT_NAME"  id="SAFE_EVENT_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$eventT->SAFE_EVENT_NAME}}" onkeyup="check_safe_event_name();">
                    <div style="color: red; font-size: 16px;" id="safe_event_name"></div>  
                </div>
                <input  type="hidden" name = "SAFE_EVENT_ID"  id="SAFE_EVENT_ID" class="form-control input-lg" value="{{$eventT->SAFE_EVENT_ID}}">
            </div>
            </div>
