...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content"> 
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขประเภทรายงาน</h2>
    <form  method="post" action="{{ route('admin.updatesafeservice') }}" enctype="multipart/form-data">
        @csrf
                <div class="row push">
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-6">
                    <input  name = "SAFE_TYPE_NAME"  id="SAFE_TYPE_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$safeT->SAFE_TYPE_NAME}}" onkeyup="check_safe_type_name();">
                    <div style="color: red; font-size: 16px;" id="safe_type_name"></div>  
                </div>
                <input  type="hidden" name = "SAFE_TYPE_ID"  id="SAFE_TYPE_ID" class="form-control input-lg" value="{{$safeT->SAFE_TYPE_ID}}">
            </div>
            </div>
