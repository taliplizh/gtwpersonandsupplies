    ...
    <div class="block" style="width: 95%;">
      ...
      <div class="row push">
                ...
                <div class="col-lg-1">
                    ...
                    <div class="col-lg-2">
                        <input  name = "LAUNDER_GETBACK_STAIN"  id="LAUNDER_GETBACK_STAIN" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infol->LAUNDER_GETBACK_STAIN}}" >
                    </div>
                    <div class="col-lg-1">
                    <label >กก.</label >
                    </div>
                <div class="col-lg-1">
                    ...
                    <div class="col-lg-2">
                        <input  name = "LAUNDER_GETBACK_INFECTIOUS"  id="LAUNDER_GETBACK_INFECTIOUS" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infol->LAUNDER_GETBACK_INFECTIOUS}}">
                    </div>
                    <div class="col-lg-1">
                    <label >กก.</label >
                    </div>
