...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" id="css-main" href="{{ asset('css/stylesl.css') }}">
        @yield('css_before')
    </head>
    <body>
        <!-- Page Container -->
            ...
            <header id="page-header">
                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-history text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">ระบบลงเวลา</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_personcheck/dashboard') ? ' active' : '' }}" href="{{ url('manager_personcheck/dashboard') }}">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_checkin/inforpersoncheck_new') ? ' active' : '' }}" href="{{ url('manager_checkin/inforpersoncheck_new') }}">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลการลงเวลาบุคคล</span>
                    
                                    </a> 
                                </li>
                                {{-- <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_personcheck/inforperson') ? ' active' : '' }}" href="{{ url('manager_personcheck/inforperson') }}">
                                    <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">New </span>
