                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-leaf text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">EVN</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_evn/dashboard') ? ' active' : '' }}" href="{{ url('manager_evn/dashboard') }}">
                                ...
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_evn/detail') ? ' active' : '' }}" href="{{ url('manager_evn/detail') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">รายละเอียด</span>
                    
                                    </a>
                                </li>
                              <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_evn/electrical') ? ' active' : '' }}" href="{{ url('manager_evn/electrical') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                ...
                                <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_evn/plumbing') ? ' active' : '' }}" href="{{ url('manager_evn/plumbing') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ระบบปะปา</span>
                    
                                    </a>
                                </li>
                                
                                 <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_evn/watertreatment') ? ' active' : '' }}" href="{{ url('manager_evn/watertreatment') }}">
                                <i class="nav-main-link-icon fa fa-calendar-alt"></i>
