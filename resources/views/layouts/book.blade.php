                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-book-open text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;">สารบรรณอิเล็กทรอนิกส์</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_book/dashboard') ? ' active' : '' }}" href="{{ url('manager_book/dashboard') }}">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_book/bookreceipt') ? ' active' : '' }}" href="{{ url('manager_book/bookreceipt') }}">
                                        <i class="nav-main-link-icon fa fa-book"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">ทะเบียนหนังสือรับ</span>
                    
                                    </a> 
                                </li>
                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_book/bookinside') ? ' active' : '' }}" href="{{ url('manager_book/bookinside') }}">
                                        <i class="nav-main-link-icon fa fa-paper-plane"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">ทะเบียนหนังสือส่ง</span>
                               ...
                               <!--<li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_book/bookinside') ? ' active' : '' }}" href="{{ url('manager_book/bookinside') }}">
                                        ...
                                        <span class="nav-main-link-name" style="font-size: 16px;">หนังสือภายใน</span>
                    
                                    </a>
                                </li>-->
                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_book/bookcommand') ? ' active' : '' }}" href="{{ url('manager_book/bookcommand') }}">
                                        <i class="nav-main-link-icon fa fa-hand-point-up"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">ทะเบียนคำสั่ง</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_book/bookannounce') ? ' active' : '' }}" href="{{ url('manager_book/bookannounce') }}">
                                        <i class="nav-main-link-icon fa fa-satellite-dish"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">ประกาศ/นโยบาย</span>
                    
                                    </a>
                                </li>

                                <!-- <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_book/report') ? ' active' : '' }}" href="{{ url('manager_book/report') }}">
                                        <i class="nav-main-link-icon fa fa-clipboard-list"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">รายงาน</span>
