                    ...
                    <div >
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                ...
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_food/infofoodrequert') ? ' active' : '' }}" href="{{ url('manager_food/infofoodrequert') }}">
                                    <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                    <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลขอซื้อวัสดุบริโภค</span>
