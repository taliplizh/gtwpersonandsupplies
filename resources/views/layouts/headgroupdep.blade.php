...
<html lang="en">
    ...
    use App\Http\Controllers\HeadgroupdepController;
    ...
    <body>
        ...
        <div id="page-container" class="page-header-dark main-content-boxed page-header-fixed">
            ...
            <!-- Header -->
            <header id="page-header" style="background-color: #b8b6b3;">
                <!-- Header Content -->
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-book-open text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;">หัวหน้างานกลุ่มงาน</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                           ...
                           <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('person_headgroupdep/dashboard') ? ' active' : '' }}" href="{{ url('person_headgroupdep/dashboard') }}">
                                ...
                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('person_headgroupdep/headgroupdep_calendarleave') ? ' active' : '' }}" href="{{ url('person_headgroupdep/headgroupdep_calendarleave') }}">
                                        <i class="nav-main-link-icon fa fa-paper-plane"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">เห็นชอบการลา</span>
                                        &nbsp;
                                        <span class="badge badge-warning" >{{HeadgroupdepController::countinfoleave()}}</span>
