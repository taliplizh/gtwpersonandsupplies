            ...
            <header id="page-header">
                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-chart-bar text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">บัญชี</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_account/dashboard') ? ' active' : '' }}" href="{{ url('manager_account/dashboard') }}">
                                ...
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_account/account_type') ? ' active' : '' }}" href="{{ url('manager_account/account_type') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">สมุดบัญชี</span>
                    
                                    </a>
                                </li>
                                
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_account/account_report') ? ' active' : '' }}" href="{{ url('manager_account/account_report') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">รายงานสมุดบัญชี</span>
                    
                                    </a>
                                </li>
                     
                                {{-- <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_account/account_bill') ? ' active' : '' }}" href="{{ url('manager_account/account_bill') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                ...
                                {{-- <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_account/account_check') ? ' active' : '' }}" href="{{ url('manager_account/account_check') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                ...
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_account/account_decline') ? ' active' : '' }}" href="{{ url('manager_account/account_decline') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ค่าเสื่อม</span>
                                ...
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_account/account_repoort') ? ' active' : '' }}" href="{{ url('manager_account/account_repoort') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name">กำหนดค่าเบื้องต้น</span>
                                    </a>
                                    <ul class="nav-main-submenu">
                                       <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/account_board') }}">
                                                <span class="nav-main-link-name">คณะกรรมการ</span>
                                            </a>
                                        </li>
                                       <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/account_creditor') }}">
                                                <span class="nav-main-link-name">ผู้แทนจำหน่าย</span>
                                            </a>
                                        </li>
                                       <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/setupaccount_accountschart') }}">
                                                <span class="nav-main-link-name">ผังบัญชี</span>
                                            </a>
                                        </li>
                                        <!--
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/setupaccount_accounttype') }}">
                                                <span class="nav-main-link-name">ประเภทสมุดบัญชี</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/account_group') }}">
                                                <span class="nav-main-link-name">หมวดบัญชี</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/account_group_sub1') }}">
                                                <span class="nav-main-link-name">หมวดบัญชีย่อย 2</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/account_group_sub2') }}">
                                                <span class="nav-main-link-name">หมวดบัญชีย่อย 3</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/account_group_sub3') }}">
                                                <span class="nav-main-link-name">หมวดบัญชีย่อย 4</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_account/account_group_sub4') }}">
                                                <span class="nav-main-link-name">บัญชีย่อย</span>
                                            </a>
                                        </li>-->
