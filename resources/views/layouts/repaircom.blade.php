                                    ...
                                    <ul class="nav-main-submenu">
                                        <li class="nav-main-item"> 
                                            <a class="nav-main-link{{ request()->is('manager_repaircom/repaircominfosetting_typesystem') ? ' active' : '' }}" href="{{ url('manager_repaircom/repaircominfosetting_typesystem') }}">
                                                <i class="nav-main-link-icon fa fa-cog"></i>
                                                <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ระบบที่ต้องการแจ้งซ่อม</span>
                                
                                            </a>
                                        </li>
                                        <li class="nav-main-item"> 
                                            <a class="nav-main-link{{ request()->is('formpdf/repaircomfunction_10999') ? ' active' : '' }}" href="{{ url('formpdf/repaircomfunction_10999') }}">
                                                <i class="nav-main-link-icon fa fa fa-cog"></i>
                                                <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ฟังก์ชันฟอร์ม</span>
