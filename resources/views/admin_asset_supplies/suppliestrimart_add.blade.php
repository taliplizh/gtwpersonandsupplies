...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลไตรมาส</h2>    

    
        <form  method="post" action="{{ route('admin.savesuppliestrimart') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-1">
      ...
      <div class="col-lg-3">
      <input  name = "TRIMART_NAME"  id="TRIMART_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_trimartname();">
