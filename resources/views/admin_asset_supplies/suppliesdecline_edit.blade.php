...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขข้อมูลหน่วยนับ</h2>    

    
        <form  method="post" action="{{ route('admin.updatesuppliesdecline') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
       ...
       <div class="col-lg-1">
         ...
         <div class="col-lg-3">
         <input  name = "DECLINE_NAME"  id="DECLINE_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesdecline->DECLINE_NAME}}" onkeyup="check_declinename();">
         ...
         <div class="col-lg-2">
         <input  name = "OLD_YEAR"  id="OLD_YEAR" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesdecline->OLD_YEAR}}" onkeyup="check_oldyear();">
         ...
         <div class="col-lg-2">
         <input  name = "DECLINE_PERSEN"  id="DECLINE_PERSEN" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesdecline->DECLINE_PERSEN}}" onkeyup="check_declinepersen();">
         ...
         <div class="col-lg-3">
         <input  name = "CODE_REF"  id="CODE_REF" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesdecline->CODE_REF}}" onkeyup="check_coderef();">
         <div style="color: red; font-size: 16px;" id="coderef"></div>  
        </div>
        
         <input type="hidden" name = "DECLINE_ID"  id="DECLINE_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesdecline->DECLINE_ID}}">

        </div>
        <div class="modal-footer">
        <div align="right">
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกแก้ไขข้อมูล</button>
         <a href="{{ url('admin_asset_supplies/setupsuppliesdecline')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" >ยกเลิก</a> 
         </div>    
