...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลพัสดุหลัก</h2>    

    
        <form  method="post" action="{{ route('admin.savesuppliestypemaster') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-1">
      ...
      <div class="col-lg-3">
      <input  name = "SUP_TYPE_MASTER_NAME"  id="SUP_TYPE_MASTER_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_mastername();">
      ...
      <div class="col-lg-6">
      <input  name = "DETAIL"  id="DETAIL" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_detail()();">  
