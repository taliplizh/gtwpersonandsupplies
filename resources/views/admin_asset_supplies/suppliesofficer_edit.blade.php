...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content"> 
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขเจ้าหน้าที่พัสดุ</h2> 
    <form  method="post" action="{{ route('admin.updateofficer') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row push">
                        <div class="col-lg-2">
                    ...
                    <div class="col-lg-4">
                        <select name="SUP_OFFICER_PERSON_ID" id="SUP_OFFICER_PERSON_ID" class="form-control input-lg js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" required>
                            ...
                            @if($infoperson ->ID == $infoofficer->SUP_OFFICER_PERSON_ID)
                        ...
                        <input type="hidden"  name = "SUP_OFFICER_ID"  id="SUP_OFFICER_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoofficer->SUP_OFFICER_ID}}">
