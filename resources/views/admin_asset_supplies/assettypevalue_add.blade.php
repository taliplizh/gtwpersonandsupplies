...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content"> 
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มประเภทครุภัณฑ์ตามมูลค่า</h2>    
        <form  method="post" action="{{ route('admin.saveassettypevalue') }}" enctype="multipart/form-data">
            @csrf
            <div class="row push">
                <div class="col-lg-2">
                ...
                <div class="col-lg-4">
                    <input  name = "TYPE_VALUE_NAME"  id="TYPE_VALUE_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_typevaluename();">
            ...
            <div class="row push">
                ...
                <div class="col-lg-10">
                    <textarea class="form-control" id="TYPE_VALUE_DETAIL" name="TYPE_VALUE_DETAIL" rows="3" onkeyup="check_typevaluedetail();"></textarea>
                    {{-- <input  name = "TYPE_VALUE_DETAIL"  id="TYPE_VALUE_DETAIL" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >   --}}
