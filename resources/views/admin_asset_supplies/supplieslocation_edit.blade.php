...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขข้อมูลตึก อาคาร สถานที่ตั้ง</h2>    

    
        <form  method="post" action="{{ route('admin.updatesupplieslocation') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-2">
      ...
      <div class="col-lg-10">
      <input  name = "LOCATION_NAME"  id="LOCATION_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosupplieslocation->LOCATION_NAME}}" onkeyup="check_localname();">
      ...
      <div class="col-lg-4">
      <input  name = "LOCATION_PHONE"  id="LOCATION_PHONE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosupplieslocation->LOCATION_PHONE}}" onkeyup="check_localphone();">
      ...
      <select name="PERSON_CONTACT_ID" id="PERSON_CONTACT_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;font-size: 13px;" onchange="check_personcontactid();">>
            ...
            @foreach ($persons as $person) 
             @if($infosupplieslocation->PERSON_CONTACT_ID == $person ->ID )
      ...
      <input type="hidden" name = "LOCATION_ID"  id="LOCATION_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosupplieslocation->LOCATION_ID}}">
