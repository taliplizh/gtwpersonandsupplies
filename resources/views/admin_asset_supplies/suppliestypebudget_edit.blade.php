...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขข้อมูลประเภทงบประมาณ</h2>    

    
        <form  method="post" action="{{ route('admin.updatesuppliestypebudget') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-2">
      ...
      <div class="col-lg-3">
      <input  name = "BUDGET_NAME"  id="BUDGET_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliestypebudget->BUDGET_NAME}}" onkeyup="check_budgetname();">
      ...
      <div class="col-lg-3">
      <input  name = "BUDGET_NUM"  id="BUDGET_NUM" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliestypebudget->BUDGET_NUM}}" onkeyup="check_budgetnum();">
      <div style="color: red; font-size: 16px;" id="budgetnum"></div>
    </div>
    
      <input  type="hidden" name = "BUDGET_ID"  id="BUDGET_ID" class="form-control input-lg" value="{{$infosuppliestypebudget->BUDGET_ID}}">
      </div></div>
        <div class="modal-footer">
        <div align="right">
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกแก้ไขข้อมูล</button>
         <a href="{{ url('admin_asset_supplies/setupsuppliestypebudget')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" >ยกเลิก</a> 
         </div>    
