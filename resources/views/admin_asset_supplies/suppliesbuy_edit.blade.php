...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขข้อมูลวิธีการจัดซื้อ/จัดจ้าง</h2>    

    
        <form  method="post" action="{{ route('admin.updatesuppliesbuy') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
       ...
       <div class="col-lg-2">
         ...
         <div class="col-lg-4">
         <input  name = "BUY_NAME"  id="BUY_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesbuy->BUY_NAME}}" onkeyup="check_buyname();">
         ...
         <div class="col-lg-4">
         <input  name = "BUY_COMMENT"  id="BUY_COMMENT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesbuy->BUY_COMMENT}} onkeyup="check_buycomment();">
         ...
         <div class="row push">
          ...
          <div class="col-lg-2">
            ...
            <div class="col-lg-4">
            <input  name = "PRICE_MIN"  id="PRICE_MIN" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesbuy->PRICE_MIN}}" onkeyup="check_pricemin();">>
            ...
            <div class="col-lg-4">
            <input  name = "PRICE_MAX"  id="PRICE_MAX" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesbuy->PRICE_MAX}}" onkeyup="check_pricemax();">
            ...
            <div class="col-lg-4">
            <input  name = "MAKE_BY"  id="MAKE_BY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesbuy->MAKE_BY}}" onkeyup="check_makeby();">
            <div style="color: red; font-size: 16px;" id="makeby"></div>   
          </div>
       
       </div>
     
      <input type="hidden"  name = "BUY_ID"  id="BUY_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliesbuy->BUY_ID}}">
    </div>
