...
<div class="block block-rounded block-bordered" style="width: 95%;margin:auto">
    <div class="block-header block-header-default">
        <h3 class="block-title">เพิ่มหน่วยนับ</h3>
    </div>
    <div class="block-content">
        <form action="{{route('mpay.mpay_setting_unit_save')}}" method="POST">
            @csrf
            <!-- Basic Elements -->
            <div class="row">
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" style="height:90px;"
                            ...
                            name="CPAY_UNIT_DETAIL" maxlength="255" placeholder="รายละเอียด..."></textarea>
                    </div>
                </div>
            </div>
            <div class="row items-push">
