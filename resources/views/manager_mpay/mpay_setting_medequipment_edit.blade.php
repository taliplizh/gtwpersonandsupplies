                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group mb-1">
                                ...
                                <input type="number" class="js-maxlength form-control js-maxlength-enabled f-kanit" id="CPAY_SET_STERILE_DAY" name="CPAY_SET_STERILE_DAY" min="1" value="{{$setequpment->CPAY_SET_STERILE_DAY}}" required >
                            </div>
                            <div class="form-group mb-1">
