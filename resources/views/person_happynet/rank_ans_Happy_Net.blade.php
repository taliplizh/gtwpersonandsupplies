    ...
    <div class="block mb-4" style="width: 95%;margin:auto">
        <div class="block-content">
            <div class="block-header block-header-default">
                <h3 class="block-title text-center fs-24"><span style="color:;">รายชื่อผู้ที่ได้รับคำชมมากที่สุด TOP 100
                </h3>
            </div>
            <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-1">
                                            <p class="font-size-lg font-w600 mb-0">
                                                # {{ $number }} &nbsp;&nbsp; <span style="color: #ffba1a"><i
                                                        class="fa fa-chess-queen fa-1x "></i></span>
                                            </p>
                                        ...
                                        <div class="col-2 text-center">
                                            <b
                                                style="font-size:2rem ;">{{ $row->HAPPY_NET_COIMPLIMENT_ID }}</b>&nbsp;&nbsp;&nbsp;
                                            <b>คำชม</b>
                                        </div>
                                        {{-- <div class="ml-3 item">
