    ...
    <div class="block-content">
        <div class="block-header block-header-default">
                   <div class="col-6">            <h3 class="block-title text-left fs-24"><i class="fa fa-power-off "></i> &nbsp;เปิดใช้
                    สถานะการใช้งานเมนูประกาศรางวัล</h3>
    </div>
                    <div class="col-6"> <a class="btn btn-hero btn-success " style="float: right;"
                        href="{{ url('person_happynet/dashboard_Happy_Net') }}"><i
        ...
        <div class="col-xl-11 center ">
            <table class="table table-hover table-bordered" width="100%" height="100%">
                ...
                <tbody >
                    ...
                    <?php $num ++ ?>
                    <tr>
                       @if ($row->HAPPY_NET_MODAL_TYPE == 'ประกาศรางวัล')
                       <td width="5%" class="text-center">{{ 1 }}</td>
                       <td width="45%" class="text-left"> ประกาศรางวัล </td>
