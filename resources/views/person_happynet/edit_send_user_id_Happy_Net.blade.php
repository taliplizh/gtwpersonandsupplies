    ...
    <div class="block mb-4" style="width: 95%;margin:auto">
        <div class="block-content">
            <div class="block-header block-header-default">
                <h3 class="block-title text-center fs-24">แก้ไขคำชื่นชม
                </h3>
            </div>
            <hr>
        ...
        <div class="block-content  shadow">
            ...
            <div class="col-12">
                <div class="block-content">
                    <form action="{{ route('happy.up_send_user_id') }}" method="post" enctype="multipart/form-data">
                        @csrf


                        <input type="hidden" id="ID_USER" name="ID_USER" value="{{ $chom_id->ID_USER }}">
                        <input type="hidden" id="HAPPY_NET_COIMPLIMENT_ID" name="HAPPY_NET_COIMPLIMENT_ID" value="{{ $chom_id->HAPPY_NET_COIMPLIMENT_ID }}">
                        <input type="hidden" id="ID_USER_INSERT" name="ID_USER_INSERT" value="{{$id_user}}">
                        <div class="col-12 row">
                            <div class="col-3">
                                <center>
                                    @if ($chom_id->HR_IMAGE == null)
                                        <img src="{{ asset('image/pers.png') }}" height="100%" width="60%">
                                    @else
                                        <img src="data:image/png;base64,{{ chunk_split(base64_encode($chom_id->HR_IMAGE)) }}"
                                            height="100%" width="60%">
                                    @endif
                                </center>
                                ...
                                <div class="col-12 row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control " id="HAPPY_NET_COIMPLIMENT_FNAME"
                                            name="HAPPY_NET_COIMPLIMENT_FNAME"
                                            value="{{ $chom_id->HAPPY_NET_COIMPLIMENT_FNAME }}" readonly>
                                    </div>
                                    <div class="col-6">
                                        <label for="HAPPY_NET_COIMPLIMENT">นามสกุล : </label><span> <input type="text"
                                                class="form-control " id="HAPPY_NET_COIMPLIMENT_LNAME"
                                                name="HAPPY_NET_COIMPLIMENT_LNAME"
                                                value="{{ $chom_id->HAPPY_NET_COIMPLIMENT_LNAME }}" readonly></span>
                                    </div>
                                </div>
                                <br>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="HAPPY_NET_COIMPLIMENT"
                                            name="HAPPY_NET_COIMPLIMENT" rows="8"
                                            placeholder="คำชื่นชม"
                                            required>{{ $chom_id->HAPPY_NET_COIMPLIMENT }}</textarea>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label class="d-block">ระดับ <span style="color:red ">ระดับเดิมอยู่ที่ ระดับ
                                                :
                                                {{ $chom_id->HAPPY_NET_DIFFICULTY_ID }}</span></label>
                                        <?php $number = 0; ?>
