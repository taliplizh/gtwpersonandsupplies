...
<div class="block mb-4" style="width: 95%;margin:auto">
    <div class="block-content">
        <div class="block-header block-header-default">
            <div class="col-12 row">
                    ...
                    <h3 class="block-title text-center fs-28"><i class="fa fa-cog "></i> &nbsp;ตั้งค่าการกำหนดการจ่ายคะแนนในแต่ละวัน</h3>
    ...
    <div class="block-content  shadow">
        ...
        <div class="grid-container">
            @if ($set_check == 0)
            <form action="{{ route('happy.update_set_coin') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="block-content">
                    <div class="form-group">
                      
                        <label for="HAPPY_NET_SET_COIN">กำหนดคะแนนในแต่ละวัน</label>
                  
                        <input type="number" class="form-control" id="HAPPY_NET_SET_COIN" name="HAPPY_NET_SET_COIN"  placeholder="กรอกตัวเลข" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}">
            ...
            @elseif ($set_check == 1)
            <form action="{{ route('happy.update_set_coins') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="block-content">
                    <div class="form-group">
                        ...
                        <input type="hidden" id="HAPPY_NET_SET_COIN_ID" name="HAPPY_NET_SET_COIN_ID" value="1">
                        <input type="number" class="form-control" id="HAPPY_NET_SET_COIN" name="HAPPY_NET_SET_COIN" value="{{ $edit_setcoins->HAPPY_NET_SET_COIN }}" placeholder="กรอกตัวเลข" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}">
