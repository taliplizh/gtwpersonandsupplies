    ...
    <div class="block mb-4" style="width: 95%;margin:auto">
        ...
        <div class="block-content">
            <div class="block-header block-header-default">
                       <div class="col-6"> <h3 class="block-title text-left fs-30">แก้ไขการจำหน่ายของรางวัล</h3></div>
        ...
        <div class="block-content  shadow"><br>
            <form action="{{ route('happy.Ucon_up') }}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" id="HAPPY_NET_ORDER_ID" name="HAPPY_NET_ORDER_ID"
                    value="{{ $con_order->HAPPY_NET_ORDER_ID }}">
                <div class="col-xl-12 row ">
                        ...
                        <center>
                            <a class="img-link img-link-zoom-in img-thumb img-lightbox"
                                ...
                                {{-- <img class="" style="width: 100%; height: 100%;"
                                    ...
                                    <img  width="400px" src="data:image/png;base64,{{ chunk_split(base64_encode($rewards->HAPPY_NET_REWARD_IMAGE)) }}">
                    ...
                    <div class="col-6  content shadow">
                            ...
                            <span>
                                @if ($con_order->HAPPY_NET_ORDER_STATUS == 'True')
                                    ...
                                    <div class="form-group">
                                        <label style="color: red" for="HAPPY_NET_ORDER_STATUS">แก้ไขสถานะ</label>&nbsp;&nbsp;
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="HAPPY_NET_ORDER_STATUS"
                                                name="HAPPY_NET_ORDER_STATUS" value="True" checked>
                                            <label class="form-check-label" for="HAPPY_NET_ORDER_STATUS">จำหน่ายแล้ว</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="HAPPY_NET_ORDER_STATUS2"
                                                name="HAPPY_NET_ORDER_STATUS" value="False">
                                            <label class="form-check-label" for="HAPPY_NET_ORDER_STATUS2">ยังไมได้จำหน่าย</label>
                                        </div>
                        ...
                        <div class="col-12">
                            <button style="float: right;" type="button" class="btn btn-primary btn-lg push"
                                data-toggle="modal" data-target="#modal-block-popin"><i
                                    class="fa fa-cloud-upload-alt mr-1"></i>
                                    ...
                                    <div class="modal-content">
                                        <div class="block block-themed block-transparent mb-0">
                                            <div class="block-header bg-primary-dark">
                                                <h3 class="block-title">ยืนยันแก้ไขข้อมูล</h3>
                                            ...
                                            <div class="block-content" style="font-size: 1.3em;">
                                                <br>
                                                <center>
                                                    "ยืนยันแก้ไขข้อมูล"
                                                </center><br>
                                            </div>
                                            <input type="hidden" id="HAPPY_NET_NAME_PAY" name="HAPPY_NET_NAME_PAY" value="">
                                            <div class="block-content block-content-full text-center bg-light">
                                                {{-- onclick="alert('แลกของรางวัลสำเหร็จ รายละเอียดการติดต่อขอรับของรางวัลดูที่หมายเหตุ')" --}}
                                                <button onclick="alert('แก้ไขข้อมูลสำเร็จ')" type="sumit"
