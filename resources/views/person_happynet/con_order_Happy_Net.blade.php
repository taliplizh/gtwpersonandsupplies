    ...
    <div class="block mb-4" style="width: 95%;margin:auto">
        ...
        <div class="block-content">
            <div class="block-header block-header-default">
                       <div class="col-6"> <h3 class="block-title text-left fs-30">ยืนยันการจำหน่ายของรางวัล</h3></div>
                ...
                <div class="col-6  content shadow">
                    <div class="row col-12">
                        <div class="col-12">
                            ...
                            ชื่อของรางวัล : <span style="color: #454545;">{{ $con_order->HAPPY_NET_REWARD_NAME }}</span>
                        </h1>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <button style="float: right;" type="button" class="btn btn-primary btn-lg push" data-toggle="modal"
                            data-target="#modal-block-popin"><i class="fa fa-cloud-upload-alt mr-1"></i>
                            &nbsp;&nbsp;จำหน่ายของรางวัล</button>
                                ...
                                <div class="modal-content">
                                    <div class="block block-themed block-transparent mb-0">
                                        <div class="block-header bg-primary-dark">
                                            <h3 class="block-title">ยืนยันการจำหน่าย</h3>
                                        ...
                                        <div class="block-content block-content-full text-right bg-light">
                                            ...
                                            <form action="{{ route('happy.con_up') }}" method="post"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" id="HAPPY_NET_ORDER_ID" name="HAPPY_NET_ORDER_ID"
                                                    value="{{ $con_order->HAPPY_NET_ORDER_ID }}">
                                                <input type="hidden" id="HAPPY_NET_ORDER_STATUS"
                                                    name="HAPPY_NET_ORDER_STATUS" value="True">
                                                ...
                                                @if ($con_order->HAPPY_NET_ORDER_STATUS == 'True')
                                                    <button onclick="alert('มีการจำหน่ายของรางวัลแล้ว')" type="button"
                                                        data-dismiss="modal" class="btn btn-md btn-primary"><i
                                                            class="far fa-check-circle fa-1x"></i><span>&nbsp;ยืนยัน</button>
                                                @else


                                                    <button onclick ="alert('จำหน่ายสำเร็จ')" type="sumit"
