    ...
    <div class="" style="width: 95%;margin:auto">
        <div class="block-content shoadow_1">
            <div class="block-header block-header-default">
                <div class="col-2"></div>
                <div class="col-8">
                    <h3 class="block-title text-center fs-24 ">ประวัติงานทั้งหมด
                    </h3>
                </div>
            ...
            <div class="grid-container">
                <div class="col-xl-11 center">
                    <table class="table table-hover table-bordered" width="100%" height="100%" id="myTable">
                        ...
                        <tbody>
                            <?php $number = 0; ?>
                            @foreach ($problem_his as $row)
                                <?php $number++; ?>
                                <tr>
                                    <td width="5%" class="text-center"> {{ $number }}</td>
                                    <td width="10%" class="text-left"> {{ datethai($row->DATE_SAVE) }}</td>
                                    <td width="20%" class="text-left"> {{ $row->HAPPY_NET_PROBLEM_HEAD }}</td>
                                    <td width="20%" class="text-left"> {{ $row->HAPPY_NET_PROBLEM }}</td>
                                    @if ($row->HAPPY_NET_PROBLEM_STATUS == 'True')
                                    <td width="10%" class="text-center"> <span class="badge badge-success">งานสำเร็จ</span></td>
                                    @else
                                    <td width="10%" class="text-center">   <span class="badge badge-danger">กำลังแก้ไขปัญหา</span></td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdown-default-outline-primary">
                                                <a class="dropdown-item"
                                                    href="{{ url('person_happynet/historycon_send_user_Happy_Net/' . $row->HAPPY_NET_PROBLEM_ID) }}">รายละเอียด</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
