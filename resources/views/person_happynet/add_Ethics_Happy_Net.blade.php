...
<div class="block mb-4" style="width: 95%;margin:auto">
    <div class="block-content">
        <div class="block-header block-header-default">
            <h3 class="block-title text-center fs-24">เพิ่มข้อมูลค่านิยม</h3>
        </div>
        <hr>

    </div>
    <div class="block-content  shadow">
        <form action="{{ route('happy.save_Ethics') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="block-content">
                <div class="form-group">
                    <label for="HAPPY_NET_SET_ETHICS">ค่านิยม</label>
                    <input type="text" class="form-control"required id="HAPPY_NET_SET_ETHICS" name="HAPPY_NET_SET_ETHICS" placeholder="ค่านิยม" >
                </div>
                <div class="form-group">
                    <label for="HAPPY_NET_SET_ETHICS_CONTENT">เนื้อหา/ความหมาย</label>
                    <textarea class="form-control" id="HAPPY_NET_SET_ETHICS_CONTENT" name="HAPPY_NET_SET_ETHICS_CONTENT" rows="4" placeholder="รายละเอียด" required></textarea>
