...
<div class="row" style="margin-top:30px;">
    <div class="col-lg-10" style="margin-left: auto; margin-right:auto; margin-top:50px;">
        <div class="block block-rounded block-bordered" style="margin-top: 30px;">
            <div class="row">
                <div class="block-header block-rounded block-bordered">
                    <?php 
                        $day = date("d");
                        $month = date("m");
                        $year = (date("Y")+543); 
                    ...
                    <div class="block-title" style="margin-top: 30px;">
                        <span style="margin-left: 30px; margin-top:30px;"><b>เพิ่มข้อมูลการทดสอบสมรรถภาพ</b></span>
                        <span>:</span>
                    ...
                    <div class="block-content">
                        <div class="row font-content-form-add">
                                            ...
                                            <div class="row">
                                                <span>หัวใจเต้น : 
                                                    <div class="row" style="margin-top: 10px;">
                                                        <div class="col-md-6"><input type="text" class="form-control input-sm" size="10"></div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12" style="margin-top: 10px;">
                                            <div class="row">
                                                <span>สูง : 
                                                    <div class="row" style="margin-top: 10px;">
                                                        <div class="col-md-6"><input type="text" class="form-control input-sm" size="12"></div>
                                                        <div class="col-md-6" style="margin-top:10px;">
                                                        </div>
                                                    </div>
                                                </span>
                            ...
                            <div class="col-md-12 text-center" style="margin-top: 30px; margin-left:auto; margin-right:auto;">
                                <div class="row">
                                    <span style="margin-left: 1200px; margin-right:10px;">
