    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header">
            <div class="block-title">
                เพิ่ม Job descriptions
            </div>
        </div>
        <div class="block-content mb-4">
            <form action="{{route('mperson.setinfo_jobd_save')}}" method="post">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <textarea name="jobdescription_name" id="" cols="30" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="col-md-2 col-form-label">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <textarea name="jobdescription_expected" id="" cols="30" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="col-md-2 col-form-label">
                            ตำแหน่ง
                        ...
                        <div class="col-md-10">
                            <div class="col-form-label custom-control custom-switch mb-1 col-sm-5">
                                <input type="checkbox" class="custom-control-input" id="jobdescription_active"
                                    name="jobdescription_active" value="1" checked="">
