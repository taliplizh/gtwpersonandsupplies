...
<script>
    ...
    //     if (number_1.val() < number_2.val() && 
    //         number_2.val() < number_3.val() && 
    //         number_3.val() < number_4.val() && 
    //         number_4.val() < number_5.val() ) {
    //     }else{
    //         Swal.fire('กำหนดค่าผิดพลาด',"กรุณากำหนดคะแนนระดับค่าเป้าหมาย คะแนนระดับ 1 - 5 จากน้อยไปมาก",'error')
    //         return false;
    //     }
    // })
