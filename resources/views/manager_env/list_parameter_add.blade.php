        ...
        <div class="block mt-5" style="width: 95%;">
            <div class="block block-rounded block-bordered">
                <div class="block-header block-header-default">
                    ...
                    <div align="left">
                        <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>เพิ่มรายการพารามิเตอร์</B></h3>
                    </div>

                </div>
                <div class="block-content block-content-full">
                    <form action="{{ route('menv.list_parameter_save') }}" method="post">
                        @csrf
                        ...
                        <div class="row push">
                            ...
                            <div class="col-lg-3 ">
                                <input name="LIST_PARAMETER_DETAIL" id="LIST_PARAMETER_DETAIL"
                            ...
                            <div class="col-lg-2 ">
                                <input name="LIST_PARAMETER_UNIT" id="LIST_PARAMETER_UNIT"
                                    class="form-control input-lg fo13" required>
                            </div>
                            <div class="col-sm-1 text-right">
                            ...
                            <div class="col-lg-3 ">
                                <input name="LIST_PARAMETER_NORMAL" id="LIST_PARAMETER_NORMAL"
                                    class="form-control input-lg fo13" required>
                            </div>
                        ...
                        <div class="footer">
                            <div align="right">
                                ...
                                <a href="{{ url('manager_env/list_parameter') }}"
