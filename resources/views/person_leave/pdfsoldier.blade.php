...
$data1.= "<br>
 ...
 $pdf->SetFont('THSarabunNew','',15);
 $pdf->WriteHTML(iconv( 'UTF-8','cp874' ,'ลาเกณฑ์ทหาร'));
...
$detail ='      รับหมายเรียกจาก '.$inforleave->ARMY_BY.' เลขที่หมายเรียก'.$inforleave->ARMY_NUM.'<br>';
$detail ='          ให้เข้ารับการ '.$inforleave->ARMY_VISIT.' ณ สถานที่'.$inforleave->ARMY_VISIT_ADD.' จึงขออนุญาตลาเกณฑ์ทหาร <br>';
...
$pdf->  Image(Storage::path('public/images/'.$sig1),105,95.5,20,10);
}

$pdf->SetFont('THSarabunNew','',15);
$pdf->Text(90,106,iconv( 'UTF-8','TIS-620','ลงชื่อ.........................................................'));
$pdf->Text(105,115,iconv( 'UTF-8','TIS-620','('.$inforleave->LEAVE_PERSON_FULLNAME.')'));
...
$pdf->  Image(Storage::path('public/images/'.$sig2),105,150.5,20,10);
}
$pdf->Text(90,160,iconv( 'UTF-8','TIS-620','ลงชื่อ..........................................................'));
$pdf->Text(105,168,iconv( 'UTF-8','TIS-620','('.$inforleave->LEADER_PERSON_NAME.')'));
$pdf->Text(98,177,iconv( 'UTF-8','TIS-620','ตำแหน่ง '.$inforleave->LEADER_POSITION_IN_WORK));
$pdf->Text(103,186,iconv( 'UTF-8','TIS-620','วันที่  '.formate($inforleave->updated_at)));
...
if($inforleave->LEAVE_STATUS_CODE == 'Allow'){ 
  $pdf-> Image(base_path('public').'/fpdf/img/checked.png',30,205,4.5,4.5);
  $pdf-> Image(base_path('public').'/fpdf/img/checkno.jpg',56,205,4.5,4.5);
}else{
  $pdf-> Image(base_path('public').'/fpdf/img/checkno.jpg',30,205,4.5,4.5);
  $pdf-> Image(base_path('public').'/fpdf/img/checkno.jpg',56,205,4.5,4.5);
}
...
$pdf->  Image(Storage::path('public/images/'.$sig4),105,235.5,20,10);
}

$pdf->Text(90,246,iconv( 'UTF-8','TIS-620','ลงชื่อ.............................................................'));
$pdf->Text(105,256,iconv( 'UTF-8','TIS-620','( '.$orgname->HR_PREFIX_NAME.''.$orgname->HR_FNAME.' '.$orgname->HR_LNAME.' )'));
$pdf->Text(98,266,iconv( 'UTF-8','TIS-620','ผู้อำนวยการ'.$orgname->ORG_NAME));
$pdf->Text(103,276,iconv( 'UTF-8','TIS-620','วันที่ '.formate($inforleave->updated_at)));
