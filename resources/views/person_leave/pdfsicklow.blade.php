...
$pdf->SetFont('THSarabunNew','',15);
$pdf->WriteHTML(iconv( 'UTF-8','cp874' ,'ลาป่วยตามกฎหมายฯ'));
...
$pdf-> Image(base_path('public').'/fpdf/img/checked.png',45,62,4,4);
$pdf-> Image(base_path('public').'/fpdf/img/checkno.jpg',45,70,4.5,4.5);
$pdf-> Image(base_path('public').'/fpdf/img/checkno.jpg',45,78,4.5,4.5);
...
$detail .= '        '.$inforleave->LEAVE_CONTACT.'<br>        โทรศัพท์ '.$inforleave->LEAVE_CONTACT_PHONE.'<br><br>';
...
$pdf-> Image(base_path('public').'/fpdf/img/checked.png',45,90.5,4,4);
$pdf-> Image(base_path('public').'/fpdf/img/checkno.jpg',63,90.5,4.5,4.5);
$pdf-> Image(base_path('public').'/fpdf/img/checkno.jpg',89,90.5,4.5,4.5);
...
$pdf-> Image(Storage::path('public/images/'.$sig1),130,118.5,20,10);
}
$pdf->WriteHTML(iconv( 'UTF-8','cp874' ,'
...
$pdf-> Image(Storage::path('public/images/'.$sig2),130,147.5,20,10);
}
...
$pdf-> Image(Storage::path('public/images/'.$sig3),130,177.5,20,10);
}
...
$pdf-> Image(Storage::path('public/images/'.$sig4),130,230.5,20,10);
}
...
$pdf-> Image(Storage::path('public/images/'.$sig5),25,177.5,20,10);
}
...
$pdf-> Image(Storage::path('public/images/'.$sig6),25,215.5,20,10);
}
...
$pdf-> Image(Storage::path('public/images/'.$sig7),25,245.5,20,10);
}
